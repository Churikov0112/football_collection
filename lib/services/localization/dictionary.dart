...
const dictionary = {
  ...
  AppGlossary.convertDuplicateToQr: {
    ...
    Languages.chineese: '将重复项转换为QR码给你的朋友？重复项将从您的收藏中删除',
  ...
  AppGlossary.openQrScannerOnSecondDevice: {
    ...
    Languages.chineese: '从侧边栏打开第二个设备的QR扫描仪并扫描代码',
  ...
  AppGlossary.scanYourFriendQrToGetPlayer: {
    ...
    Languages.chineese: '扫描朋友的QR码获取玩家',
