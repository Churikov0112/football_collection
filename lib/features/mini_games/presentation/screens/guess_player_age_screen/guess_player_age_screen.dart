...
part 'guess_player_age_screen_presenter.dart';
part 'widgets/guess_options.dart';

class GuessPlayerAgeScreen extends StatelessWidget {
  const GuessPlayerAgeScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: GuessPlayerAgeScreenPresenter(
        child: Builder(
          builder: (context) {
                ...
                children: [
                  ...
                  >(
                    builder: (context, randomPlayersState) {
                      ...
                      final correctAnswer = player!.age!;
                      final wrongOptions = <int>[];
                      for (final item in allPlayers) {
                        final age = item.age;
                        if (age == null ||
                            age == correctAnswer ||
                            wrongOptions.contains(age)) {
                          continue;
                        }
                        wrongOptions.add(age);
                      }
                  ...
                  Translator(
                    termin: AppGlossary.guessPlayerAge,
