...
class GuessPlayerNumberScreenPresenter extends StatefulWidget {
  static GuessPlayerNumberScreenPresenterState of(BuildContext context) {
    return context
        .findAncestorStateOfType<GuessPlayerNumberScreenPresenterState>()!;
  }
  ...
  @override
  State<GuessPlayerNumberScreenPresenter> createState() =>
      GuessPlayerNumberScreenPresenterState();
}

class GuessPlayerNumberScreenPresenterState
    extends State<GuessPlayerNumberScreenPresenter>
  ...
  void loadRandomPlayers() {
    if (mounted) {
      ...
      context.read<RandomFootballPlayersBloc>().add(
        RandomFootballPlayersEventGet(count: 4, withTeamShirtNumber: true),
      );
    }
  }
