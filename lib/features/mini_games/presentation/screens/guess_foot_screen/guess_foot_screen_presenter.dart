...
class GuessFootScreenPresenter extends StatefulWidget {
  static GuessFootScreenPresenterState of(BuildContext context) {
    return context.findAncestorStateOfType<GuessFootScreenPresenterState>()!;
  }
