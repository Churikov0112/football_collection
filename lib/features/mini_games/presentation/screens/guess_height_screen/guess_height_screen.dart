...
part 'guess_height_screen_presenter.dart';
part 'widgets/guess_options.dart';

class GuessHeightScreen extends StatelessWidget {
  const GuessHeightScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: GuessHeightScreenPresenter(
        child: Builder(
          builder: (context) {
            final presenter = GuessHeightScreenPresenter.of(context);
                ...
                children: [
                  ...
                  >(
                    builder: (context, randomPlayersState) {
                      ...
                      final correctAnswer = player!.height!;
                      final wrongOptions = <int>[];
                      for (final item in allPlayers) {
                        final height = item.height;
                        if (height == null ||
                            height == correctAnswer ||
                            wrongOptions.contains(height)) {
                          continue;
                        }
                        wrongOptions.add(height);
                      }
                  ...
                  Translator(
                    termin: AppGlossary.guessHeight,
