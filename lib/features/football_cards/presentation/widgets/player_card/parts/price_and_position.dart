...
class _PriceAndPosition extends StatelessWidget {
  const _PriceAndPosition({required this.player, required this.marketValueVisibility});
  ...
  Widget build(BuildContext context) {
    ...
    return Wrap(
      spacing: 4,
      children: [
        if (player.marketValue != null && marketValueVisibility != .none)
          _RoundedContainer(text: marketValueVisibility == .quest ? "?" : beautifyTransferValue(player.marketValue!)),
